...
/**
 * BACKUP funcionalidade de clicar na foto do usuário
 * <a href="#" (click)="onProfileClick($event)" id="sidebar-profile-button">
        <img src="assets/layout/images/user-default.png" width="100px" alt="california-layout"/>
...
@Component({
    ...
    template: `
        <div class="user-profile">
            <a id="sidebar-profile-button">
                <img src="assets/layout/images/user-default.png" width="100px" alt="california-layout"/>
                <span class="sidebar-profile-name">{{getFullname()}}</span>
                <!--<span class="sidebar-profile-role">Administrator</span>-->
            </a>
